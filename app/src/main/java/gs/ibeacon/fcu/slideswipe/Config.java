...
public class Config {
    ...
    public static int MINOR1 = 1;
    public static int MINOR2 = 1;
    public static int MINOR3 = 1;

    public static String LOCATIONLABEL1 = "資電234 - 網際網路及軟體工程學程實驗室";
    public static String LOCATIONLABEL2 = "資電222 - 第三國際會議廳";
    public static String LOCATIONLABEL3 = "資電214";
}
